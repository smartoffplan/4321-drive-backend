...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "Multi-vendor vehicle rental broker platform API. Browse vehicles, manage vendors, handle listings, and track inquiries.",
      contact: {
        name: "4321 Drive",
      },
    },
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          bearerFormat: "JWT",
          description:
            "Enter your access token from /auth/login or /auth/register",
        },
      },
      schemas: {
        ErrorResponse: {
        ...
        User: {
          ...
          properties: {
            ...
            phone: { type: "string", example: "+971543218884" },
